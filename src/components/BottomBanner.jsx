...
const BottomBanner = () => {
    return (
        <div className='relative mt-24'>
            ...
            <img src={assets.bottom_banner_image_sm} alt="bottom_banner_image_sm" className='w-full md:hidden' />
            <div className='absolute inset-0 flex flex-col items-center md:items-end md:justify-center pt-16 mt:pt-0 md:pr-24'>
                <div>
